...
# ### Apresentação
# Este arquivo faz a classificação de malware para Android utilizando a *view* *opcodes*, sem seleção de características. O resultado final deste *notebook* mostra os resultados utilizados no artigo.
...
OUTPUT_FILE = RESULTS_DIR / "result_roc_opcodes_pca.png"
RANDOM_STATE = 42
TRAIN_SIZE = 0.7

def load_data():
    apicalls_y_path = NPY_DIR / "opcodes-y-full-ordered.npz"
    apicalls_x_path = NPY_DIR / "opcodes-x-pca-ordered.npz"
...
def run_experiment():
    ...
    dt = DecisionTreeClassifier(min_samples_split=100, random_state=RANDOM_STATE)
