...
OUTPUT_FILE = RESULTS_DIR / "result_roc_apicalls_pca.png"
RANDOM_STATE = 42
TRAIN_SIZE = 0.7
...
def load_data():
    ...
    apicalls_y_path = NPY_DIR /  "apicalls-y-full-ordered.npz"
    apicalls_x_path = NPY_DIR /  "apicalls-x-pca-ordered.npz"
